...
\multirow{4}{*}{WFH} & \multirow{2}{*}{Positive} & \begin{tabular}[c]{@{}l@{}}Ability to directly request data \\ authorized personnel.\end{tabular}         & 4                              \\ \cline{3-4} 
...
\hline
Area                 & Aspect                      & Question                                                                                                                                                                                          & \multicolumn{1}{l|}{Frecuency} \\ \hline
\multirow{7}{*}{WFA} & \multirow{2}{*}{Positive}   & \begin{tabular}[c]{@{}l@{}}Ability to directly request \\ data from authorized personnel.\end{tabular}                                                                                            & 6                              \\ \cline{3-4} 
                     &                             & \begin{tabular}[c]{@{}l@{}}Kemampuan memilih lokasi yang lebih \\ produktif dan inspiratif.\end{tabular}                                                                                          & 5                              \\ \cline{2-4} 
                     & \multirow{2}{*}{Negative}   & \begin{tabular}[c]{@{}l@{}}Rawan terjadinya masalah teknis dan\\  masalah komunikasi jika tidak terbiasa \\ berkomunikasi melalui media telekomunikasi.\end{tabular}                              & 5                              \\ \cline{3-4} 
                     &                             & \begin{tabular}[c]{@{}l@{}}Tidak fleksibel dalam hal waktu dan tempat \\ untuk pekerjaan tertentu.\end{tabular}                                                                                   & 6                              \\ \cline{2-4} 
                     & \multirow{3}{*}{Challanges} & \begin{tabular}[c]{@{}l@{}}Kesulitan berinteraksi dengan keluarga, \\ anak-anak teralihkan dengan game online\\ atau situs-situs lain yang tidak terkait \\ dengan materi pelajaran.\end{tabular} & 3                              \\ \cline{3-4} 
                     &                             & \begin{tabular}[c]{@{}l@{}}Kerusakan yang sulit diatasi jika terjadi\\ pada jaringan atau teknologi yang digunakan.\end{tabular}                                                                  & 5                              \\ \cline{3-4} 
                     &                             & Sulit Fokus                                                                                                                                                                                       & 3                              \\ \hline
\end{tabular}
\end{table}
...
\centering
\captionof{table}{WFA Answer Frecuency} \label{tab:title} 
...
\centering
\captionof{table}{Pembagian Area Balanced Scorecard dan Deksripsinya} \label{tab:title} 
...
\hline
Area                 & Aspect                      & Question                                                                                                                                                                                              & \multicolumn{1}{l|}{Frecuency} & Area \\ \hline
